...
$banner = $websiteUrl . "/files/images/logo.png";$page = $_GET['page']; 
if ($page == ""){
    $page = 1;
}
?>
...
<head>
    <title>Ongoing Anime on <?=$websiteTitle?></title>
    <script async src="https://arc.io/widget.min.js#VtsaVyfg"></script>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Ongoing Anime on <?=$websiteTitle?>">
    ...
    <meta property="og:title" content="Ongoing Anime on <?=$websiteTitle?>">
    <meta property="og:description" content="Ongoing Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                $json = file_get_contents("$api/ongoing-anime?page=$page");
                                    ...
                                    <div class="flw-item">
                                        <div class="film-poster">
                                            ...
                                            <a class="film-poster-ahref"
                                                href="<?=$websiteUrl?>/anime/<?=$ongoing['animeId']?>"
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           $ongoingPage = file_get_contents("$api/ongoingPage?page=$page");
