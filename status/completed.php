...
<head>
    <title>Completed Anime on <?=$websiteTitle?></title>
    <script async src="https://arc.io/widget.min.js#VtsaVyfg"></script>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Completed Anime on <?=$websiteTitle?>">
    ...
    <meta property="og:title" content="Completed Anime on <?=$websiteTitle?>">
    <meta property="og:description" content="Completed Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
