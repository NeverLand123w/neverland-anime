...
<body>
    ...
    <div id="app-mount">
        ...
        <div id="main-wrapper" class="page-home">
            <div class="container">
                <!-- Recently Added -->
                <div id="recently-updated-box" class="anime_box">
                    <div class="ab_-header">
                        <h2 class="box_title"><a href="" class="hovertext">Popular</a></h2>
                        <div class="controls">
                            <div class="ctr ctr-prev"><i class="fas fa-chevron-left"></i></div>
                            <div class="ctr ctr-next"><i class="fas fa-chevron-right"></i></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="ab_-content">
                        <div class="anime_swipe">
                            <div class="anime_loading">
                                <div class="loading_circle"><i class="spinner-border"></i></div>
                            </div>
                                    ...
                                    <div
                                        class="swiper-container swiper-container-initialized swiper-container-horizontal">
                                            <div class="swiper-wrapper" >
                                                ...
                                                <div class="swiper-slide" style="width:198px!important;">
                                                    <div class="item">
                                                        <div class="hover-popular" style="overflow:hidden;">
                                                            <a href="anime/<?=$popular['animeId']?>"
                                                                class="film-poster" title="<?=$popular['animeTitle']?>">
                                                                <img data-src="<?=$popular['imgUrl']?>"
                                                                    src="<?=$popular['imgUrl']?>"
                                                                    class="film-poster-img lazyload"
                                                                    alt="<?=$popular['animeTitle']?>">
                                                            </a>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="anime_detail">
                                                            <h3 class="anime_name headingA1 text-cut"
                                                                data-jname="<?=$popular['animeTitle']?>"><a
                ...
                <!--/ Recently Added -->
                <div id="recently-added-box" class="anime_box">
                    <div class="ab_-header">
                        <h2 class="box_title"><a href="" class="hovertext">Recently Updated</a></h2>
                        <div class="controls">
                            <div class="ctr ctr-prev"><i class="fas fa-chevron-left"></i></div>
                            <div class="ctr ctr-next"><i class="fas fa-chevron-right"></i></div>
                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="hover-popular" style="overflow:hidden;">
                                                        <a href="watch/<?=$recentRelease['episodeId']?>"
                                                            class="film-poster" title="<?=$recentRelease['name']?>">
                                                            <img data-src="<?=$recentRelease['imgUrl']?>"
                                                    ...
                                                    <div class="anime_detail">
                                                        <h3 class="anime_name headingA1 text-cut"
                                                            data-jname="<?=$recentRelease['name']?>"><a
                            ...
                            <section class="block_area block_area_sidebar block_area-schedule schedule-full">
                                <div class="block_area-header">
                                    ...
                                    <div class="float-left bah-time">
                                        <div class="float-left bah-heading mr-4" style="padding:20px 20px 0" ;>
                                            <h2 class="cat-heading">Estimated Schedule</h2>
                                        </div>
                                        <span class="current-time" style="padding-left: 20px;padding-bottom 20px;"><span
                                                id="timezone">(GMT+05:30)</span> <span id="current-date">
                                                <?=date("d")?>/
                                                <?=date("m")?>/
                                                <?=date("Y")?>
                                            </span> <span id="clock">
                                ...
                                foreach($json['results'] as $schedule) { ?>
                                            ...
                                            <li>
                                                <a href="/anilist/anime?id=<?=$schedule['id']?>"
                                                    class="tsl-link">
                                                    <div class="time">
                                                        <?php echo date("H:i", $schedule['airingAt']);?>
                                                    </div>
                                                    <div class="film-detail">
                                                        <h3 class="film-name dynamic-name"
                                                            data-jname="<?=$title['romaji']?>">
                                                            <?=$title['romaji']?>
                                                        </h3>
                                                        <div class="fd-play">
